...
export const USER_PASS_RES_FAIL =  "USER_PASS_RES_FAIL";
export const USER_PASS_RES_REQUEST = "USER_PASS_RES_REQUEST";
export const USER_PASS_RES_SUCCESS = "USER_PASS_RES_SUCCESS";
export const USER_PASS_RES_RESET  = "USER_PASS_RES_RESET";
export const USER_PASS_RESE_FAIL =  "USER_PASS_RESE_FAIL";
export const USER_PASS_RESE_REQUEST = "USER_PASS_RESE_REQUEST";
export const USER_PASS_RESE_SUCCESS = "USER_PASS_RESE_SUCCESS";
export const USER_PASS_RESE_RESET  = "USER_PASS_RESE_RESET";
